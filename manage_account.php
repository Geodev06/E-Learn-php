...
<body onload="Datetime()">
	...
	<div id="main" class="p-5">
		<h4 id="ls">Managing Accounts<p style="font-size: 16px;">Account registration</p></h4>
		<hr>
    <a href="accounts_view.php"><i class="fas fa-eye text-primary"><span style="font-size: 12px; font-family: 'calibri';cursor: pointer;"> show all accounts</span></i></a>
    <iframe src="account_registration.php"height="800px" width="1000px;" style="border: 0; margin-top: 3px;" class="shaddow"> </iframe>
		</div>
<!-- Modal -->
