          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              include 'connect.php';
               ...
               ?>
               <select class="cb" id="sel1" name="cbcourse">
                <option>--Choose one--</option>
           ...
           <div class="p-2">
            <!-- ModalPrmt -->
                     ...
                     <h3 class="text-white prmH">|Prompt?</h5>
                      ...
                      <div class="text-right">
                       <div class="row">
                         <div class="col-lg-12">
                     <div class="custom-control-inline">
                    <div class="text-left pr-5"><p class=" pr-5 prmText">Are you sure you want to save this?</p></div>
                      <button  type="submit" name="btnSave_sub"  class="mybtnD" id="yes">Yes</button>
                      <div class="pl-3"></div>
              ...
              <input type="button"  value="Save" class="btSave" data-toggle="modal" data-target="#myModalP">
           </div>
          </div>
        </form>
      </div>
